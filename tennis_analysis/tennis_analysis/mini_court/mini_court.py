...
import tennis_analysis.constants as constants
from tennis_analysis.utils.conversions import (
    convert_meters_to_pixel_distance,
    convert_pixel_distance_to_meters,
)
from tennis_analysis.utils.bbox_utils import (
    get_foot_position,
...
class MiniCourt:
    ...
    def convert_meters_to_pixels(self, meters):
        return convert_meters_to_pixel_distance(
            meters, constants.DOUBLE_LINE_WIDTH, self.court_drawing_with
        )
    ...
    def set_court_drawing_key_points(self):
        ...
        # point 0
        drawing_key_points[0], drawing_key_points[1] = int(
            self.court_start_x
        ), int(self.court_start_y)
        # point 1
        drawing_key_points[2], drawing_key_points[3] = int(
            self.court_end_x
        ), int(self.court_start_y)
        # point 2
        drawing_key_points[4] = int(self.court_start_x)
        drawing_key_points[5] = int(
            self.court_start_y
        ) + self.convert_meters_to_pixels(constants.HALF_COURT_LINE_HEIGHT * 2)
        # point 3
        drawing_key_points[6] = drawing_key_points[0] + self.court_drawing_with
        drawing_key_points[7] = drawing_key_points[5]
        # point 4
        drawing_key_points[8] = drawing_key_points[
            0
        ] + self.convert_meters_to_pixels(constants.DOUBLE_ALLY_DIFFERENCE)
        drawing_key_points[9] = drawing_key_points[1]
        # point 5
        drawing_key_points[10] = drawing_key_points[
            4
        ] + self.convert_meters_to_pixels(constants.DOUBLE_ALLY_DIFFERENCE)
        drawing_key_points[11] = drawing_key_points[5]
        # point 6
        drawing_key_points[12] = drawing_key_points[
            2
        ] - self.convert_meters_to_pixels(constants.DOUBLE_ALLY_DIFFERENCE)
        drawing_key_points[13] = drawing_key_points[3]
        # point 7
        drawing_key_points[14] = drawing_key_points[
            6
        ] - self.convert_meters_to_pixels(constants.DOUBLE_ALLY_DIFFERENCE)
        drawing_key_points[15] = drawing_key_points[7]
        # point 8
        drawing_key_points[16] = drawing_key_points[8]
        drawing_key_points[17] = drawing_key_points[
            9
        ] + self.convert_meters_to_pixels(constants.NO_MANS_LAND_HEIGHT)
        # point 9
        drawing_key_points[18] = drawing_key_points[
            16
        ] + self.convert_meters_to_pixels(constants.SINGLE_LINE_WIDTH)
        drawing_key_points[19] = drawing_key_points[17]
        # point 10
        drawing_key_points[20] = drawing_key_points[10]
        drawing_key_points[21] = drawing_key_points[
            11
        ] - self.convert_meters_to_pixels(constants.NO_MANS_LAND_HEIGHT)
        # point 11
        drawing_key_points[22] = drawing_key_points[
            20
        ] + self.convert_meters_to_pixels(constants.SINGLE_LINE_WIDTH)
        drawing_key_points[23] = drawing_key_points[21]
        # point 12
        drawing_key_points[24] = (
            drawing_key_points[16] + drawing_key_points[18]
        ) / 2
        drawing_key_points[25] = drawing_key_points[17]
        # point 13
        drawing_key_points[26] = (
            drawing_key_points[20] + drawing_key_points[22]
        ) / 2
    ...
    def set_mini_court_position(self):
        ...
        self.court_drawing_with = self.court_end_x - self.court_start_x
    ...
    def draw_court(self, frame):
        ...
        for line in self.lines:
            # point 0: 0, 1 # line la 14 con poin thi co 0 voi 1
            # point 1: 2, 3
            # point 2: 4, 5
            start_point = (
        ...
        net_end_point = (
            int(
                self.drawing_key_points[0]
                + self.convert_meters_to_pixels(constants.DOUBLE_LINE_WIDTH)
            ),
            int((self.drawing_key_points[1] + self.drawing_key_points[5]) / 2),
        )
    ...
    def get_width_of_mini_court(self):
        return self.court_drawing_with
