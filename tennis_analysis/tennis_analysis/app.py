...
from tennis_analysis.utils.video_utils import read_video, save_video
from tennis_analysis.trackers.player_tracker import PlayerTracker
from tennis_analysis.trackers.ball_tracker import BallTracker
from tennis_analysis.court_line_detector.court_line_detector import (
    CourtLineDetector,
)
from tennis_analysis.mini_court.mini_court import MiniCourt
from tennis_analysis.utils.bbox_utils import measure_distance
from tennis_analysis.utils.conversions import convert_pixel_distance_to_meters
import tennis_analysis.constants as constansts
from tennis_analysis.utils.player_stats_drawer_utils import drawer_player_stats


def main():
    input_video_path = "tennis_analysis/input_videos/input_video.mp4"
    video_frames = read_video(input_video_path)

    # Detect Players and Ball
    player_tracker = PlayerTracker(model_path="yolov8x")
    ball_tracker = BallTracker(hub_model_id="chanelcolgate/tennis-analysis-v1")
    ...
    court_model_path = "tennis_analysis/models/keypoints_model.pth"
    ...
    player_mini_court_position, ball_mini_court_position = (
    ...
    for ball_shot_ind in range(len(ball_shot_frames) - 1):
        ...
        distance_covered_by_ball_meters = convert_pixel_distance_to_meters(
            ...
            constansts.DOUBLE_LINE_WIDTH,
            mini_court.get_width_of_mini_court(),
        )

        # Speed of the ball shot in km/h
        speed_of_the_ball_shot = (
            distance_covered_by_ball_meters / ball_shot_time_in_seconds * 3.6
        )

        # Player who the ball
        player_positions = player_mini_court_position[start_frame]
        ...
        distance_covered_by_opponent_pixels = measure_distance(
            ...
            player_mini_court_position[end_frame][opponent_player_id],
        )
        ...
        speed_of_opponent = (
            distance_covered_by_opponent_meters
        ...
        current_player_stats[
            f"player_{opponent_player_id}_last_player_speed"
        ] = speed_of_opponent
    ...
    output_video_frames = mini_court.draw_points_on_mini_court(
        output_video_frames, player_mini_court_position
    )
    output_video_frames = mini_court.draw_points_on_mini_court(
        output_video_frames, ball_mini_court_position, color=(0, 255, 255)
    )

    ## Draw Player Stats
    output_video_frames = drawer_player_stats(
    ...
    save_video(
        output_video_frames, "tennis_analysis/output_videos/output_video.avi"
    )
